...
const updatePage = newPage => {
  ...
  <Router>
    ...
    <Route exact path="/user/:uid/website"><WebsiteList getWebsites={getWebsites} />
    </Route>
    <Route exact path="/user/:uid/website/new"><WebsiteNew getWebsites={getWebsites} addWebsite={addWebsite} />
    </Route>
    ...
    <Route exact path="/user/:uid/website/:wid/page"><PageList getPages={getPages} />
    </Route>
    <Route exact path="/user/:uid/website/:wid/page/new" ></Route>
  <PageNew addPage={addPage} />
    <Route exact path="/user/:uid/website/:wid/page/:pid" 
  ><PageEdit getPage={getPage} removePage={removePage} updatePage={updatePage} />
  </Route>
